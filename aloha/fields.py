...
class HTMLField(models.TextField):
    ...
    def _process_links(self, frag):
        for a in frag.cssselect('a'):
            ...
            if 'href' in a.attrib and not a.attrib['href'].startswith("/") and not a.attrib['href'].startswith(".") and urlparse.urlparse(a.attrib['href']).netloc.split('.')[-2:]!=['day9', 'tv']:
